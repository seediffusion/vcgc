...
poker-position-dealer = Você é o dealer.
poker-position-dealer-seat = Você está { $position } lugar após o dealer.
poker-position-dealer-seats = Você está { $position } lugares após o dealer.
