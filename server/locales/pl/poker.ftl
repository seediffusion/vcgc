...
poker-position-dealer = Jesteś rozdającym.
poker-position-dealer-seat = Jesteś { $position } miejsce po rozdającym.
poker-position-dealer-seats = Jesteś { $position } miejsca po rozdającym.
